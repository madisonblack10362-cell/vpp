class BuildingSetEntry : VPPPlayerTemplate
{
    ...
    void BuildingSetEntry(GridSpacerWidget grid, Widget rootWidget,string itemSetName)
    {
		...
		GetVPPUIManager().HookConfirmationDialog(m_DeleteItem, rootWidget,this,"DeleteItem", DIAGTYPE.DIAG_YESNO, "#VSTR_OB_DELETE_ITEM_TITLE", "#VSTR_ESP_DEL_CONFIRM_2 "+itemSetName+" #VSTR_ESP_DEL_CONFIRM_3");
